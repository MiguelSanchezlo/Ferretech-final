<h3>🔐 Cambiar Contraseña de Empresa</h3>
...
<form id="form-password-empresa" method="POST" action="../../Controller/EmpresaController.php">
...
<script>
document.getElementById("form-password-empresa").addEventListener("submit", function (e) {
